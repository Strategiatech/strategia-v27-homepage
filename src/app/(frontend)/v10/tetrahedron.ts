...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v10-hero') as HTMLElement | null
  const _stage = document.getElementById('v10Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v10Edges')
  const _glowEl = document.getElementById('v10Glow')
  const _stop0 = document.getElementById('v10GlowStop0')
  const _stop1 = document.getElementById('v10GlowStop1')
  const cursorAura = document.getElementById('v10CursorAura')
  const plasmaLayer = document.getElementById('v10PlasmaLayer')
  const _pulsesG = document.getElementById('v10Pulses')
  const spacer = document.querySelector('.v10-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v10:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v10-plasma-blob'
  ...
  function spawnPulse() {
    ...
    ring.setAttribute('fill', 'url(#v10PulseGrad)')
    ring.setAttribute('filter', 'url(#v10PulseBlur)')
