...
export default function V21Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('v21:complete', handler)
    return () => window.removeEventListener('v21:complete', handler)
  }, [])
  ...
  useEffect(() => {
    const els = document.querySelectorAll<HTMLElement>('.v21-reveal')
  ...
  return (
    <div className={`v21${complete ? ' v21--complete' : ''}`}>
      <div className="v21-pulse-overlay" id="v21PulseOverlay" aria-hidden="true" />

      {/* ================================================================
          NAVIGATION  (V21 #2 — visible from page load)
          ================================================================ */}
      <nav className="v21-nav" ref={navRef}>
        <a href="/v21" className="v21-nav-logo">
          <svg className="v21-nav-mark" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <ul className="v21-nav-links">
          <li><a href="#platform" className="v21-nav-link">Platform</a></li>
          <li><a href="#modules" className="v21-nav-link">Modules</a></li>
          <li><a href="#science" className="v21-nav-link">Science</a></li>
          <li><a href="#solutions" className="v21-nav-link">Solutions</a></li>
          <li><a href="#enterprise" className="v21-nav-link">Enterprise</a></li>
          <li><a href="#process" className="v21-nav-link">Process</a></li>
        </ul>
        <a href="#demo" className="v21-nav-cta">Book demo</a>
      </nav>
      ...
      <section className="v21-hero">
        <div className="v21-cursor-aura" id="v21CursorAura" aria-hidden="true" />
        ...
        <div className="v21-hero-copy">
          ...
          <div className="v21-hero-actions">
            <a href="#demo" className="v21-btn-primary">Book a demo</a>
            <a href="#platform" className="v21-link-arrow">
              Explore the platform<span aria-hidden="true"> ↗</span>
            </a>
          </div>
        </div>

        <div className="v21-tetra-stage" id="v21Stage">
          <svg id="v21Tetra" viewBox="-110 -110 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <radialGradient id="v21CoreGlow" cx="50%" cy="50%" r="50%">
                <stop id="v21GlowStop0" offset="0%" stopColor="var(--glow-color)" stopOpacity="0.55" />
                <stop id="v21GlowStop1" offset="40%" stopColor="var(--glow-color)" stopOpacity="0.18" />
                <stop offset="100%" stopColor="var(--glow-color)" stopOpacity="0" />
              </radialGradient>
              <radialGradient id="v21PulseGrad" cx="50%" cy="50%" r="50%">
              ...
              <filter id="v21GlowBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="6" />
              </filter>
              <filter id="v21PulseBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="10" />
              </filter>
            </defs>
            <g id="v21Pulses" />
            <circle id="v21Glow" cx="0" cy="0" r="60" fill="url(#v21CoreGlow)" filter="url(#v21GlowBlur)" />
            <g id="v21Edges" />
          </svg>

          <div className="v21-brand-lockup" id="v21BrandLockup" aria-hidden="true">
            <img src="/images/brand/strategia-wordmark-white.svg" alt="Strategia" />
          </div>
        </div>
      </section>
      <div className="v21-scroll-spacer" aria-hidden="true" />

      {/* ================================================================
          TRUSTED BY — Marquee  (V21 #5 — label now matches the list,
          which contains a software marketplace alongside health systems)
          ================================================================ */}
      <div className="v21-marquee-strip">
        <div className="v21-marquee-label">Trusted by leading<br />health systems &amp; platforms</div>
        <div className="v21-marquee-track">
          <div className="v21-marquee-inner">
            {[...CLIENTS, ...CLIENTS].map((c, i) => (
              <div key={i} className="v21-marquee-item">
                <span className="v21-marquee-dot" aria-hidden="true" />
                {c}
              </div>
            ))}
          </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-stats v21-reveal">
        <div className="v21-stats-grid">
          <div className="v21-stat-card">
            <div className="v21-stat-value">80%</div>
            <div className="v21-stat-label">Of internal recruitment automated</div>
            <div className="v21-stat-sub">Median across deployed health systems</div>
          </div>
          <div className="v21-stat-card">
            <div className="v21-stat-value">&lt;25 min</div>
            <div className="v21-stat-label">1,000 CVs end-to-end</div>
            <div className="v21-stat-sub">From requisition to ranked shortlist</div>
          </div>
          <div className="v21-stat-card">
            <div className="v21-stat-value">0.74</div>
            <div className="v21-stat-label">Match-score validity (mature)</div>
            <div className="v21-stat-sub">vs. 0.18 for resume review (Sackett 2022)</div>
          </div>
        </div>
      </section>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-section" id="modules">
        <div className="v21-section-inner v21-reveal">
          <div className="v21-section-header">
            <div>
              <div className="v21-eyebrow">The Platform &middot; 08 V-modules</div>
              <h2 className="v21-h2">Eight modules. One hire-and-retain loop.</h2>
            </div>
            <a href="#platform" className="v21-link-arrow">
          ...
          <div className="v21-modules-phased">
            {PHASES.map((phase) => {
              const phaseModules = MODULES.filter((m) => m.tag === phase.name)
              const cardCountClass =
                phaseModules.length === 1
                  ? 'v21-module-phase-cards--1'
                  : phaseModules.length === 2
                  ? 'v21-module-phase-cards--2'
                  : ''
              return (
                <div key={phase.name} className="v21-module-phase">
                  <div className="v21-module-phase-header">
                    <span className="v21-module-phase-step">Phase {phase.step}</span>
                    <span className="v21-module-phase-name">{phase.name}</span>
                    <p className="v21-module-phase-desc">{phase.desc}</p>
                  </div>
                  <div className={`v21-module-phase-cards ${cardCountClass}`}>
                    {phaseModules.map((mod) => (
                      <div key={mod.title} className="v21-module">
                        <div className="v21-module-header">
                          <span className="v21-module-num">{mod.num}</span>
                          <span className="v21-module-tag">{mod.tag}</span>
                        </div>
                        <div className="v21-module-title">{mod.title}</div>
                        <p className="v21-module-desc">{mod.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-triangulate">
        <div className="v21-triangulate-inner v21-reveal">
          <div className="v21-eyebrow">The Triangulate Method&trade;</div>
          <h2 className="v21-h2">Three signals. One score.</h2>
          <p className="v21-desc">
          ...
          <div className="v21-eyebrow" style={{ marginTop: 40, marginBottom: 0, fontSize: 10 }}>
            Role &middot; ICU Nurse Specialist &middot; <span style={{ color: 'rgba(255,255,255,0.4)' }}>authored by V-Job</span>
          </div>

          <div className="v21-tri-signals">
            <div className="v21-tri-signal">
              <div className="v21-tri-signal-bar v21-tri-signal-bar--parse" />
              <div className="v21-tri-signal-label">CV signal</div>
              <div className="v21-tri-signal-name">V-Parse&trade;</div>
            </div>
            <div className="v21-tri-signal">
              <div className="v21-tri-signal-bar v21-tri-signal-bar--psych" />
              <div className="v21-tri-signal-label">Psych signal</div>
              <div className="v21-tri-signal-name">V-Psych&trade;</div>
            </div>
            <div className="v21-tri-signal">
              <div className="v21-tri-signal-bar v21-tri-signal-bar--interview" />
              <div className="v21-tri-signal-label">Interview signal</div>
              <div className="v21-tri-signal-name">V-Interview&trade;</div>
            </div>
          </div>

          <div className="v21-tri-converge">
            <div className="v21-tri-converge-dot" />
          </div>

          <div className="v21-tri-result">
            <div className="v21-tri-result-header">
              <span className="status">V-Fit &middot; Synthesis complete</span>
              <span>L. Ortega &middot; ICU Nurse Specialist</span>
            </div>
            <div className="v21-tri-result-body">
              <div className="v21-tri-score-block">
                <div className="v21-tri-score-label">JobFit&trade; Score</div>
                <div className="v21-tri-score-value">94</div>
                <div className="v21-tri-verdict">
              ...
              <div className="v21-tri-evidence">
                <div className="v21-tri-evidence-title">Key evidence</div>
                <ul className="v21-tri-evidence-list">
                  <li className="v21-tri-evidence-item">
                    <span className="v21-tri-evidence-tag">V-Parse</span>
                    <div>
                      <div className="v21-tri-evidence-text">Reg. Nurse (RN) License</div>
                      <div className="v21-tri-evidence-sub">Verified &middot; Lic. ID #PR01</div>
                    </div>
                  </li>
                  <li className="v21-tri-evidence-item">
                    <span className="v21-tri-evidence-tag">V-Psych</span>
                    <div>
                      <div className="v21-tri-evidence-text">Resilience + Empathy</div>
                      <div className="v21-tri-evidence-sub">T = 64 / 61 &middot; ICU role-fit cohort</div>
                    </div>
                  </li>
                  <li className="v21-tri-evidence-item">
                    <span className="v21-tri-evidence-tag">V-Interview</span>
                    <div>
                      <div className="v21-tri-evidence-text">Decision quality</div>
                      <div className="v21-tri-evidence-sub">0.91 weighted &middot; 4 scenario probes</div>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-section" id="science">
        <div className="v21-section-inner v21-reveal">
          <div className="v21-section-header">
            <div>
              <div className="v21-eyebrow">The Science</div>
              <h2 className="v21-h2">
                Built on peer-reviewed psychometrics &mdash; <span className="muted">not retrofitted retail norms.</span>
              </h2>
              <p className="v21-desc" style={{ marginTop: 24 }}>
                Every score the platform produces is grounded in published validity research,
                calibrated on healthcare populations.
              </p>
            </div>
            <div className="v21-hero-actions">
              <a href="/science" className="v21-btn-outline">Read the research</a>
              <a href="/science" className="v21-link-arrow">
                Methodology<span aria-hidden="true"> ↗</span>
              </a>
            </div>
          </div>

          <div className="v21-science-grid">
            <div className="v21-science-stat">
              <div className="v21-science-stat-header">
      ...
      {/* ================================================================
          SOLUTIONS
          ================================================================ */}
      <section className="v21-section" id="solutions">
        <div className="v21-section-inner v21-reveal">
          <div className="v21-eyebrow">Solutions</div>
          <h2 className="v21-h2">
            Built for the people who own the workforce &mdash;{' '}
            <span className="muted">CHRO, recruiter, executive, clinical operator.</span>
          </h2>

          <div className="v21-solutions-grid">
            {SOLUTIONS.map((sol) => (
              <div key={sol.title} className="v21-solution-card">
                <div className="v21-solution-role">{sol.role}</div>
                <div className="v21-solution-title">{sol.title}</div>
                <p className="v21-solution-quote">{sol.quote}</p>
                <p className="v21-solution-body">{sol.body}</p>
                <div className="v21-solution-link">Explore <span aria-hidden="true">&rarr;</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-section" id="enterprise">
        <div className="v21-section-inner v21-reveal">
          <div className="v21-enterprise-wrap">
            <div className="v21-enterprise-bg" aria-hidden="true" />
            <div className="v21-enterprise-content">
              <div>
                <div className="v21-eyebrow">Enterprise</div>
                <h2 className="v21-h2">Deploy to the most regulated workforces in the country.</h2>
                <p className="v21-desc" style={{ marginTop: 24 }}>
                ...
                <div className="v21-hero-actions" style={{ marginTop: 32 }}>
                  <a href="/enterprise" className="v21-btn-outline">Enterprise &amp; security</a>
                  <a href="/process" className="v21-link-arrow">
                    Deployment process<span aria-hidden="true"> ↗</span>
                  </a>
                </div>
              </div>
              <div className="v21-badges-grid">
                {BADGES.map((b) => (
                  <div key={b} className="v21-badge-item">
                    <span className="v21-badge-check" aria-hidden="true">&#10003;</span>
                    {b}
                  </div>
                ))}
              </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-section" id="process">
        <div className="v21-section-inner v21-reveal">
          <div className="v21-process-wrap">
            <div className="v21-process-bg" aria-hidden="true" />
            <div style={{ position: 'relative' }}>
              <div className="v21-eyebrow">Our Process</div>
              <h2 className="v21-h2">Five steps from requisition to retained outcome.</h2>
              <p className="v21-desc">
                Every Strategia engagement runs the same disciplined loop. The output of
                every step is auditable, exportable, and yours.
              </p>

              <div className="v21-process-steps">
                <div className="v21-process-line" aria-hidden="true" />
                {PROCESS_STEPS.map((step) => (
                  <div key={step.num} className="v21-process-step">
                    <div className="v21-process-step-num">{step.num}</div>
                    <div className="v21-process-step-title">{step.title}</div>
                    <div className="v21-process-step-module">{step.module}</div>
                    <p className="v21-process-step-desc">{step.desc}</p>
                  </div>
                ))}
              </div>

              <div className="v21-hero-actions" style={{ marginTop: 48 }}>
                <a href="/process" className="v21-btn-outline">Full process</a>
                <a href="/process" className="v21-link-arrow">
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-section" id="roi">
        <div className="v21-section-inner v21-reveal">
          <div className="v21-eyebrow">ROI calculator</div>
          <h2 className="v21-h2">See the savings for your&nbsp;system.</h2>
          <p className="v21-desc">
            Three inputs. Conservative assumptions. A number you can take to
            your&nbsp;CFO.
          </p>

          <div className="v21-roi-grid">
            <div className="v21-roi-inputs">
              <div>
                <div className="v21-roi-input-header">
                  <span className="k">Total Employees</span>
                  <span className="v">{ftes.toLocaleString()}</span>
                </div>
                <input
                  type="range"
                  className="v21-roi-slider"
            ...
            <div className="v21-roi-output">
              <div className="v21-roi-output-label">Projected annual savings</div>
              <div className="v21-roi-output-value">
                <span className="dollar">$</span>
                <span className="num">{bigValue}</span>
              </div>
              <p className="v21-roi-output-sub">
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v21-cta-section" id="demo">
        <div className="v21-cta-wrap v21-reveal">
          <div className="v21-cta-bg" aria-hidden="true" />
          <img
            src="/images/brand/glow/inline/strategia-final-logo-strategia-inline-white-glow.png"
            alt="Strategia"
            className="v21-cta-logo"
          />
          <h2 className="v21-h2">Cut avoidable attrition. Defend every hire.</h2>
          <p className="v21-desc">
            Most executives have great strategy and an opaque workforce. Strategia closes the gap.
          </p>
          <div className="v21-cta-actions">
            <a href="/demo" className="v21-btn-primary">Book a demo</a>
            <a href="/process" className="v21-link-arrow">
              Talk to us<span aria-hidden="true"> ↗</span>
            </a>
      ...
      <footer className="v21-footer">
        <div className="v21-footer-inner">
          <div className="v21-footer-top">
            <div className="v21-footer-brand">
              ...
              <div className="v21-footer-version">Strategia Intelligence Engine v2.1 &mdash; Live</div>
            </div>
          ...
          <div className="v21-footer-bottom">
            <div className="v21-footer-bottom-left">&copy; 2026 Strategia, Inc. All rights reserved.</div>
            <div className="v21-footer-bottom-right">
              <a href="/">Privacy</a>
              <a href="/">Terms</a>
