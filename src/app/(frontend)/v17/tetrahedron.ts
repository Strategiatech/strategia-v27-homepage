...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v17-hero') as HTMLElement | null
  const _stage = document.getElementById('v17Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v17Edges')
  const _glowEl = document.getElementById('v17Glow')
  const _stop0 = document.getElementById('v17GlowStop0')
  const _stop1 = document.getElementById('v17GlowStop1')
  const cursorAura = document.getElementById('v17CursorAura')
  const plasmaLayer = document.getElementById('v17PlasmaLayer')
  const _pulsesG = document.getElementById('v17Pulses')
  const pulseOverlay = document.getElementById('v17PulseOverlay')
  const spacer = document.querySelector('.v17-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v17:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v17-plasma-blob'
  ...
  const wireBackRGB = { r: 80, g: 148, b: 140 }
  ...
  function spawnPulse() {
    ...
    ring.setAttribute('fill', 'url(#v17PulseGrad)')
    ring.setAttribute('filter', 'url(#v17PulseBlur)')
