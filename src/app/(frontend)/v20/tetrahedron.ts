...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v20-hero') as HTMLElement | null
  const _stage = document.getElementById('v20Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v20Edges')
  const _glowEl = document.getElementById('v20Glow')
  const _stop0 = document.getElementById('v20GlowStop0')
  const _stop1 = document.getElementById('v20GlowStop1')
  const cursorAura = document.getElementById('v20CursorAura')
  const plasmaLayer = document.getElementById('v20PlasmaLayer')
  const _pulsesG = document.getElementById('v20Pulses')
  const pulseOverlay = document.getElementById('v20PulseOverlay')
  const spacer = document.querySelector('.v20-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v20:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v20-plasma-blob'
  ...
  function spawnPulse() {
    ...
    ring.setAttribute('fill', 'url(#v20PulseGrad)')
    ring.setAttribute('filter', 'url(#v20PulseBlur)')
