...
export default function V20Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('v20:complete', handler)
    return () => window.removeEventListener('v20:complete', handler)
  }, [])
  ...
  useEffect(() => {
    const els = document.querySelectorAll<HTMLElement>('.v20-reveal')
  ...
  return (
    <div className={`v20${complete ? ' v20--complete' : ''}`}>
      <div className="v20-pulse-overlay" id="v20PulseOverlay" aria-hidden="true" />

      {/* ================================================================
          NAVIGATION
          ================================================================ */}
      <nav className="v20-nav" ref={navRef}>
        <a href="/v20" className="v20-nav-logo">
          <svg className="v20-nav-mark" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <ul className="v20-nav-links">
          <li><a href="#platform" className="v20-nav-link">Platform</a></li>
          <li><a href="#modules" className="v20-nav-link">Modules</a></li>
          <li><a href="#science" className="v20-nav-link">Science</a></li>
          <li><a href="#solutions" className="v20-nav-link">Solutions</a></li>
          <li><a href="#enterprise" className="v20-nav-link">Enterprise</a></li>
          <li><a href="#process" className="v20-nav-link">Process</a></li>
        </ul>
        <a href="#demo" className="v20-nav-cta">Book demo</a>
      </nav>
      ...
      <section className="v20-hero">
        <div className="v20-cursor-aura" id="v20CursorAura" aria-hidden="true" />
        <div className="v20-plasma-layer" id="v20PlasmaLayer" aria-hidden="true" />
        ...
        <div className="v20-hero-copy">
          ...
          <div className="v20-hero-actions">
            <a href="#demo" className="v20-btn-primary">Book a demo</a>
            <a href="#platform" className="v20-link-arrow">
              Explore the platform<span aria-hidden="true"> ↗</span>
            </a>
          </div>
        </div>

        <div className="v20-tetra-stage" id="v20Stage">
          <svg id="v20Tetra" viewBox="-110 -110 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <radialGradient id="v20CoreGlow" cx="50%" cy="50%" r="50%">
                <stop id="v20GlowStop0" offset="0%" stopColor="var(--glow-color)" stopOpacity="0.55" />
                <stop id="v20GlowStop1" offset="40%" stopColor="var(--glow-color)" stopOpacity="0.18" />
                <stop offset="100%" stopColor="var(--glow-color)" stopOpacity="0" />
              </radialGradient>
              <radialGradient id="v20PulseGrad" cx="50%" cy="50%" r="50%">
              ...
              <filter id="v20GlowBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="6" />
              </filter>
              <filter id="v20PulseBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="10" />
              </filter>
            </defs>
            <g id="v20Pulses" />
            <circle id="v20Glow" cx="0" cy="0" r="60" fill="url(#v20CoreGlow)" filter="url(#v20GlowBlur)" />
            <g id="v20Edges" />
          </svg>

          <div className="v20-brand-lockup" id="v20BrandLockup" aria-hidden="true">
            <img src="/images/brand/strategia-wordmark-white.svg" alt="Strategia" />
          </div>
        </div>
      </section>
      <div className="v20-scroll-spacer" aria-hidden="true" />

      {/* ================================================================
          TRUSTED BY — Marquee
          ================================================================ */}
      <div className="v20-marquee-strip">
        <div className="v20-marquee-label">Trusted by leading<br />health systems</div>
        <div className="v20-marquee-track">
          <div className="v20-marquee-inner">
            {[...CLIENTS, ...CLIENTS].map((c, i) => (
              <div key={i} className="v20-marquee-item">
                <span className="v20-marquee-dot" aria-hidden="true" />
                {c}
              </div>
            ))}
          </div>
      ...
      {/* ================================================================
          STATS
          ================================================================ */}
      <section className="v20-stats v20-reveal">
        <div className="v20-stats-grid">
          <div className="v20-stat-card">
            <div className="v20-stat-card-header">
              <span>01</span><span>Outcome</span>
            </div>
            <div className="v20-stat-value">80%</div>
            <div className="v20-stat-label">Of internal recruitment automated</div>
            <div className="v20-stat-sub">Median across deployed health systems</div>
          </div>
          <div className="v20-stat-card">
            <div className="v20-stat-card-header">
              <span>02</span><span>Outcome</span>
            </div>
            <div className="v20-stat-value">&lt;25 min</div>
            <div className="v20-stat-label">1,000 CVs end-to-end</div>
            <div className="v20-stat-sub">From requisition to ranked shortlist</div>
          </div>
          <div className="v20-stat-card">
            <div className="v20-stat-card-header">
              <span>03</span><span>Outcome</span>
            </div>
            <div className="v20-stat-value">0.74</div>
            <div className="v20-stat-label">Match-score validity (mature)</div>
            <div className="v20-stat-sub">vs. 0.18 for resume review (Sackett 2022)</div>
          </div>
        </div>
      </section>
      ...
      {/* ================================================================
          PLATFORM — 8 Modules
          ================================================================ */}
      <section className="v20-section" id="modules">
        <div className="v20-section-inner v20-reveal">
          <div className="v20-section-header">
            <div>
              <div className="v20-eyebrow">The Platform &middot; 08 V-modules</div>
              <h2 className="v20-h2">
          ...
          <div className="v20-modules-grid">
            {MODULES.map((mod) => (
              <div key={mod.title} className="v20-module">
                <div className="v20-module-header">
                  <span className="v20-module-num">{mod.num}</span>
                  <span className="v20-module-tag">{mod.tag}</span>
                </div>
                <div className="v20-module-title">{mod.title}</div>
                <p className="v20-module-desc">{mod.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v20-triangulate">
        <div className="v20-triangulate-inner v20-reveal">
          <div className="v20-eyebrow">The Triangulate Method&trade;</div>
          <h2 className="v20-h2">
            Three signals. <span className="muted">One defensible composite score.</span>
          </h2>
          <p className="v20-desc">
          ...
          <div className="v20-eyebrow" style={{ marginTop: 40, marginBottom: 0, fontSize: 10 }}>
            Role &middot; ICU Nurse Specialist &middot; <span style={{ color: 'rgba(255,255,255,0.4)' }}>authored by V-Job</span>
          </div>

          <div className="v20-tri-signals">
            <div className="v20-tri-signal">
              <div className="v20-tri-signal-bar v20-tri-signal-bar--parse" />
              <div className="v20-tri-signal-label">CV signal</div>
              <div className="v20-tri-signal-name">V-Parse&trade;</div>
            </div>
            <div className="v20-tri-signal">
              <div className="v20-tri-signal-bar v20-tri-signal-bar--psych" />
              <div className="v20-tri-signal-label">Psych signal</div>
              <div className="v20-tri-signal-name">V-Psych&trade;</div>
            </div>
            <div className="v20-tri-signal">
              <div className="v20-tri-signal-bar v20-tri-signal-bar--interview" />
              <div className="v20-tri-signal-label">Interview signal</div>
              <div className="v20-tri-signal-name">V-Interview&trade;</div>
            </div>
          </div>

          <div className="v20-tri-converge">
            <div className="v20-tri-converge-dot" />
          </div>

          <div className="v20-tri-result">
            <div className="v20-tri-result-header">
              <span className="status">V-Fit &middot; Synthesis complete</span>
              <span>L. Ortega &middot; ICU Nurse Specialist</span>
            </div>
            <div className="v20-tri-result-body">
              <div className="v20-tri-score-block">
                <div className="v20-tri-score-label">JobFit&trade; Score</div>
                <div className="v20-tri-score-value">94</div>
                <div className="v20-tri-verdict">
              ...
              <div className="v20-tri-evidence">
                <div className="v20-tri-evidence-title">Key evidence</div>
                <ul className="v20-tri-evidence-list">
                  <li className="v20-tri-evidence-item">
                    <span className="v20-tri-evidence-tag">V-Parse</span>
                    <div>
                      <div className="v20-tri-evidence-text">Reg. Nurse (RN) License</div>
                      <div className="v20-tri-evidence-sub">Verified &middot; Lic. ID #PR01</div>
                    </div>
                  </li>
                  <li className="v20-tri-evidence-item">
                    <span className="v20-tri-evidence-tag">V-Psych</span>
                    <div>
                      <div className="v20-tri-evidence-text">Resilience + Empathy</div>
                      <div className="v20-tri-evidence-sub">T = 64 / 61 &middot; ICU role-fit cohort</div>
                    </div>
                  </li>
                  <li className="v20-tri-evidence-item">
                    <span className="v20-tri-evidence-tag">V-Interview</span>
                    <div>
                      <div className="v20-tri-evidence-text">Decision quality</div>
                      <div className="v20-tri-evidence-sub">0.91 weighted &middot; 4 scenario probes</div>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      {/* ================================================================
          SCIENCE
          ================================================================ */}
      <section className="v20-section" id="science">
        <div className="v20-section-inner v20-reveal">
          <div className="v20-section-header">
            <div>
              <div className="v20-eyebrow">The Science</div>
              <h2 className="v20-h2">
                Built on peer-reviewed psychometrics &mdash; <span className="muted">not retrofitted retail norms.</span>
              </h2>
              <p className="v20-desc" style={{ marginTop: 24 }}>
                Every score the platform produces is grounded in published validity research,
                calibrated on healthcare populations.
              </p>
            </div>
            <div className="v20-hero-actions">
              <a href="/science" className="v20-btn-outline">Read the research</a>
              <a href="/science" className="v20-link-arrow">
                Methodology<span aria-hidden="true"> ↗</span>
              </a>
            </div>
          </div>

          <div className="v20-science-grid">
            <div className="v20-science-stat">
              <div className="v20-science-stat-header">
      ...
      <section className="v20-section" id="solutions">
        <div className="v20-section-inner v20-reveal">
          <div className="v20-eyebrow">Solutions</div>
          <h2 className="v20-h2">
            Built for the people who own the workforce &mdash;{' '}
            <span className="muted">CHRO, recruiter, executive, clinical operator.</span>
          </h2>

          <div className="v20-solutions-grid">
            {SOLUTIONS.map((sol) => (
              <div key={sol.title} className="v20-solution-card">
                <div className="v20-solution-role">{sol.role}</div>
                <div className="v20-solution-title">{sol.title}</div>
                <p className="v20-solution-quote">{sol.quote}</p>
                <p className="v20-solution-body">{sol.body}</p>
                <div className="v20-solution-link">Explore <span aria-hidden="true">&rarr;</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ENTERPRISE
          ================================================================ */}
      <section className="v20-section" id="enterprise">
        <div className="v20-section-inner v20-reveal">
          <div className="v20-enterprise-wrap">
            <div className="v20-enterprise-bg" aria-hidden="true" />
            <div className="v20-enterprise-content">
              <div>
                <div className="v20-eyebrow">Enterprise</div>
                <h2 className="v20-h2">Deploy to the most regulated workforces in the country.</h2>
                <p className="v20-desc" style={{ marginTop: 24 }}>
                ...
                <div className="v20-hero-actions" style={{ marginTop: 32 }}>
                  <a href="/enterprise" className="v20-btn-outline">Enterprise &amp; security</a>
                  <a href="/process" className="v20-link-arrow">
                    Deployment process<span aria-hidden="true"> ↗</span>
                  </a>
                </div>
              </div>
              <div className="v20-badges-grid">
                {BADGES.map((b) => (
                  <div key={b} className="v20-badge-item">
                    <span className="v20-badge-check" aria-hidden="true">&#10003;</span>
                    {b}
                  </div>
                ))}
              </div>
      ...
      {/* ================================================================
          PROCESS
          ================================================================ */}
      <section className="v20-section" id="process">
        <div className="v20-section-inner v20-reveal">
          <div className="v20-process-wrap">
            <div className="v20-process-bg" aria-hidden="true" />
            <div style={{ position: 'relative' }}>
              <div className="v20-eyebrow">Our Process</div>
              <h2 className="v20-h2">Five steps from requisition to retained outcome.</h2>
              <p className="v20-desc">
                Every Strategia engagement runs the same disciplined loop. The output of
                every step is auditable, exportable, and yours.
              </p>

              <div className="v20-process-steps">
                <div className="v20-process-line" aria-hidden="true" />
                {PROCESS_STEPS.map((step) => (
                  <div key={step.num} className="v20-process-step">
                    <div className="v20-process-step-num">{step.num}</div>
                    <div className="v20-process-step-title">{step.title}</div>
                    <div className="v20-process-step-module">{step.module}</div>
                    <p className="v20-process-step-desc">{step.desc}</p>
                  </div>
                ))}
              </div>

              <div className="v20-hero-actions" style={{ marginTop: 48 }}>
                <a href="/process" className="v20-btn-outline">Full process</a>
                <a href="/process" className="v20-link-arrow">
      ...
      {/* ================================================================
          ROI CALCULATOR
          ================================================================ */}
      <section className="v20-section" id="roi">
        <div className="v20-section-inner v20-reveal">
          <div className="v20-eyebrow">ROI calculator</div>
          <h2 className="v20-h2">See the savings for your&nbsp;system.</h2>
          <p className="v20-desc">
            Three inputs. Conservative assumptions. A number you can take to
            your&nbsp;CFO.
          </p>

          <div className="v20-roi-grid">
            <div className="v20-roi-inputs">
              <div>
                <div className="v20-roi-input-header">
                  <span className="k">Total Employees</span>
                  <span className="v">{ftes.toLocaleString()}</span>
                </div>
                <input
                  type="range"
                  className="v20-roi-slider"
            ...
            <div className="v20-roi-output">
              <div className="v20-roi-output-label">Projected annual savings</div>
              <div className="v20-roi-output-value">
                <span className="dollar">$</span>{bigValue}
              </div>
              <p className="v20-roi-output-sub">
      ...
      {/* ================================================================
          FINAL CTA
          ================================================================ */}
      <section className="v20-cta-section" id="demo">
        <div className="v20-cta-wrap v20-reveal">
          <div className="v20-cta-bg" aria-hidden="true" />
          <img
            src="/images/brand/glow/inline/strategia-final-logo-strategia-inline-white-glow.png"
            alt="Strategia"
            className="v20-cta-logo"
          />
          <h2 className="v20-h2">Turn hiring into a strategic lever.</h2>
          <p className="v20-desc">
      ...
      <footer className="v20-footer">
        <div className="v20-footer-inner">
          <div className="v20-footer-top">
            <div className="v20-footer-brand">
              ...
              <div className="v20-footer-version">Strategia Intelligence Engine v2.0 &mdash; Live</div>
            </div>
          ...
          <div className="v20-footer-bottom">
            <div className="v20-footer-bottom-left">&copy; 2026 Strategia, Inc. All rights reserved.</div>
            <div className="v20-footer-bottom-right">
              <a href="/">Privacy</a>
              <a href="/">Terms</a>
