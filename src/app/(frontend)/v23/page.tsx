...
export default function V23Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('v23:complete', handler)
    return () => window.removeEventListener('v23:complete', handler)
  }, [])
  ...
  useEffect(() => {
    const els = document.querySelectorAll<HTMLElement>('.v23-reveal')
  ...
  return (
    <div className={`v23${complete ? ' v23--complete' : ''}`}>
      <div className="v23-pulse-overlay" id="v23PulseOverlay" aria-hidden="true" />

      {/* ================================================================
          NAVIGATION  (V21 #2 — visible from page load)
          ================================================================ */}
      <nav className="v23-nav" ref={navRef}>
        <a href="/v23" className="v23-nav-logo">
          <svg className="v23-nav-mark" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <ul className="v23-nav-links">
          <li><a href="#platform" className="v23-nav-link">Platform</a></li>
          <li><a href="#modules" className="v23-nav-link">Modules</a></li>
          <li><a href="#science" className="v23-nav-link">Science</a></li>
          <li><a href="#solutions" className="v23-nav-link">Solutions</a></li>
          <li><a href="#enterprise" className="v23-nav-link">Enterprise</a></li>
          <li><a href="#process" className="v23-nav-link">Process</a></li>
        </ul>
        <a href="#demo" className="v23-nav-cta">Book demo</a>
      </nav>
      ...
      <section className="v23-hero">
        <div className="v23-cursor-aura" id="v23CursorAura" aria-hidden="true" />
        <div className="v23-plasma-layer" id="v23PlasmaLayer" aria-hidden="true" />
        ...
        <div className="v23-hero-copy">
          ...
          <div className="v23-hero-actions">
            <a href="#demo" className="v23-btn-primary">Book a demo</a>
            <a href="#platform" className="v23-link-arrow">
              Explore the platform<span aria-hidden="true"> ↗</span>
            </a>
          </div>
        </div>

        <div className="v23-tetra-stage" id="v23Stage">
          <svg id="v23Tetra" viewBox="-110 -110 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <radialGradient id="v23CoreGlow" cx="50%" cy="50%" r="50%">
                <stop id="v23GlowStop0" offset="0%" stopColor="var(--glow-color)" stopOpacity="0.55" />
                <stop id="v23GlowStop1" offset="40%" stopColor="var(--glow-color)" stopOpacity="0.18" />
                <stop offset="100%" stopColor="var(--glow-color)" stopOpacity="0" />
              </radialGradient>
              <radialGradient id="v23PulseGrad" cx="50%" cy="50%" r="50%">
              ...
              <filter id="v23GlowBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="6" />
              </filter>
              <filter id="v23PulseBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="10" />
              </filter>
            </defs>
            <g id="v23Pulses" />
            <circle id="v23Glow" cx="0" cy="0" r="60" fill="url(#v23CoreGlow)" filter="url(#v23GlowBlur)" />
            <g id="v23Edges" />
          </svg>

          <div className="v23-brand-lockup" id="v23BrandLockup" aria-hidden="true">
            <img src="/images/brand/strategia-wordmark-white.svg" alt="Strategia" />
          </div>
        </div>
      </section>
      <div className="v23-scroll-spacer" aria-hidden="true" />

      {/* ================================================================
          TRUSTED BY — Marquee  (V21 #5 — label now matches the list,
          which contains a software marketplace alongside health systems)
          ================================================================ */}
      <div className="v23-marquee-strip">
        <div className="v23-marquee-label">Trusted by leading<br />health systems &amp; platforms</div>
        <div className="v23-marquee-track">
          <div className="v23-marquee-inner">
            {[...CLIENTS, ...CLIENTS].map((c, i) => (
              <div key={i} className="v23-marquee-item">
                <span className="v23-marquee-dot" aria-hidden="true" />
                {c}
              </div>
            ))}
          </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-stats v23-reveal">
        <div className="v23-stats-grid">
          <div className="v23-stat-card">
            <div className="v23-stat-value">80%</div>
            <div className="v23-stat-label">Of internal recruitment automated</div>
            <div className="v23-stat-sub">Median across deployed health systems</div>
          </div>
          <div className="v23-stat-card">
            <div className="v23-stat-value">&lt;25 min</div>
            <div className="v23-stat-label">1,000 CVs end-to-end</div>
            <div className="v23-stat-sub">From requisition to ranked shortlist</div>
          </div>
          <div className="v23-stat-card">
            <div className="v23-stat-value">0.74</div>
            <div className="v23-stat-label">Match-score validity (mature)</div>
            <div className="v23-stat-sub">vs. 0.18 for resume review (Sackett 2022)</div>
          </div>
        </div>
      </section>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-section" id="modules">
        <div className="v23-section-inner v23-reveal">
          <div className="v23-section-header">
            <div>
              <div className="v23-eyebrow">The Platform &middot; 08 V-modules</div>
              <h2 className="v23-h2">Eight modules. <span className="accent accent--teal">One hire-and-retain loop.</span></h2>
            </div>
            <a href="#platform" className="v23-link-arrow">
          ...
          <div className="v23-modules-phased">
            {PHASES.map((phase) => {
              const phaseModules = MODULES.filter((m) => m.tag === phase.name)
              const cardCountClass =
                phaseModules.length === 1
                  ? 'v23-module-phase-cards--1'
                  : phaseModules.length === 2
                  ? 'v23-module-phase-cards--2'
                  : ''
              return (
                <div key={phase.name} className="v23-module-phase">
                  <div className="v23-module-phase-header">
                    <span className="v23-module-phase-step">Phase {phase.step}</span>
                    <span className="v23-module-phase-name">{phase.name}</span>
                    <p className="v23-module-phase-desc">{phase.desc}</p>
                  </div>
                  <div className={`v23-module-phase-cards ${cardCountClass}`}>
                    {phaseModules.map((mod) => (
                      <div key={mod.title} className="v23-module">
                        <div className="v23-module-header">
                          <span className="v23-module-num">{mod.num}</span>
                          <span className="v23-module-tag">{mod.tag}</span>
                        </div>
                        <div className="v23-module-title">{mod.title}</div>
                        <p className="v23-module-desc">{mod.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-triangulate">
        <div className="v23-triangulate-inner v23-reveal">
          <div className="v23-eyebrow">The Triangulate Method&trade;</div>
          <h2 className="v23-h2">Three signals. <span className="accent accent--lime">One score.</span></h2>
          <p className="v23-desc">
          ...
          <div className="v23-eyebrow" style={{ marginTop: 40, marginBottom: 0, fontSize: 10 }}>
            Role &middot; ICU Nurse Specialist &middot; <span style={{ color: 'rgba(255,255,255,0.65)' }}>authored by V-Job</span>
          </div>

          <div className="v23-tri-signals">
            <div className="v23-tri-signal">
              <div className="v23-tri-signal-bar v23-tri-signal-bar--parse" />
              <div className="v23-tri-signal-label">CV signal</div>
              <div className="v23-tri-signal-name">V-Parse&trade;</div>
            </div>
            <div className="v23-tri-signal">
              <div className="v23-tri-signal-bar v23-tri-signal-bar--psych" />
              <div className="v23-tri-signal-label">Psych signal</div>
              <div className="v23-tri-signal-name">V-Psych&trade;</div>
            </div>
            <div className="v23-tri-signal">
              <div className="v23-tri-signal-bar v23-tri-signal-bar--interview" />
              <div className="v23-tri-signal-label">Interview signal</div>
              <div className="v23-tri-signal-name">V-Interview&trade;</div>
            </div>
          </div>

          <div className="v23-tri-converge">
            <div className="v23-tri-converge-dot" />
          </div>

          <div className="v23-tri-result">
            <div className="v23-tri-result-header">
              <span className="status">V-Fit &middot; Synthesis complete</span>
              <span>L. Ortega &middot; ICU Nurse Specialist</span>
            </div>
            <div className="v23-tri-result-body">
              <div className="v23-tri-score-block">
                <div className="v23-tri-score-label">JobFit&trade; Score</div>
                <div className="v23-tri-score-value">94</div>
                <div className="v23-tri-verdict">
              ...
              <div className="v23-tri-evidence">
                <div className="v23-tri-evidence-title">Key evidence</div>
                <ul className="v23-tri-evidence-list">
                  <li className="v23-tri-evidence-item">
                    <span className="v23-tri-evidence-tag">V-Parse</span>
                    <div>
                      <div className="v23-tri-evidence-text">Reg. Nurse (RN) License</div>
                      <div className="v23-tri-evidence-sub">Verified &middot; Lic. ID #PR01</div>
                    </div>
                  </li>
                  <li className="v23-tri-evidence-item">
                    <span className="v23-tri-evidence-tag">V-Psych</span>
                    <div>
                      <div className="v23-tri-evidence-text">Resilience + Empathy</div>
                      <div className="v23-tri-evidence-sub">T = 64 / 61 &middot; ICU role-fit cohort</div>
                    </div>
                  </li>
                  <li className="v23-tri-evidence-item">
                    <span className="v23-tri-evidence-tag">V-Interview</span>
                    <div>
                      <div className="v23-tri-evidence-text">Decision quality</div>
                      <div className="v23-tri-evidence-sub">0.91 weighted &middot; 4 scenario probes</div>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-section" id="science">
        <div className="v23-section-inner v23-reveal">
          <div className="v23-section-header">
            <div>
              <div className="v23-eyebrow">The Science</div>
              <h2 className="v23-h2">
                Built on <span className="accent accent--sky">peer-reviewed psychometrics</span> &mdash; <span className="muted">not retrofitted retail norms.</span>
              </h2>
              <p className="v23-desc" style={{ marginTop: 24 }}>
                Every score the platform produces is grounded in published validity research,
                calibrated on healthcare populations.
              </p>
            </div>
            <div className="v23-hero-actions">
              <a href="/science" className="v23-btn-outline">Read the research</a>
              <a href="/science" className="v23-link-arrow">
                Methodology<span aria-hidden="true"> ↗</span>
              </a>
            </div>
          </div>

          <div className="v23-science-grid">
            <div className="v23-science-stat">
              <div className="v23-science-stat-header">
      ...
      {/* ================================================================
          SOLUTIONS
          ================================================================ */}
      <section className="v23-section" id="solutions">
        <div className="v23-section-inner v23-reveal">
          <div className="v23-eyebrow">Solutions</div>
          <h2 className="v23-h2">
            Built for the people who <span className="accent accent--teal">own the workforce</span> &mdash;{' '}
            <span className="muted">CHRO, recruiter, executive, clinical operator.</span>
          </h2>

          <div className="v23-solutions-grid">
            {SOLUTIONS.map((sol) => (
              <div key={sol.title} className="v23-solution-card">
                <div className="v23-solution-role">{sol.role}</div>
                <div className="v23-solution-title">{sol.title}</div>
                <p className="v23-solution-quote">{sol.quote}</p>
                <p className="v23-solution-body">{sol.body}</p>
                <div className="v23-solution-link">Explore <span aria-hidden="true">&rarr;</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-section" id="enterprise">
        <div className="v23-section-inner v23-reveal">
          <div className="v23-enterprise-wrap">
            <div className="v23-enterprise-bg" aria-hidden="true" />
            <div className="v23-enterprise-content">
              <div>
                <div className="v23-eyebrow">Enterprise</div>
                <h2 className="v23-h2">Deploy to the <span className="accent accent--lime">most regulated workforces</span> in the country.</h2>
                <p className="v23-desc" style={{ marginTop: 24 }}>
                ...
                <div className="v23-hero-actions" style={{ marginTop: 32 }}>
                  <a href="/enterprise" className="v23-btn-outline">Enterprise &amp; security</a>
                  <a href="/process" className="v23-link-arrow">
                    Deployment process<span aria-hidden="true"> ↗</span>
                  </a>
                </div>
              </div>
              <div className="v23-badges-grid">
                {BADGES.map((b) => (
                  <div key={b} className="v23-badge-item">
                    <span className="v23-badge-check" aria-hidden="true">&#10003;</span>
                    {b}
                  </div>
                ))}
              </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-section" id="process">
        <div className="v23-section-inner v23-reveal">
          <div className="v23-process-wrap">
            <div className="v23-process-bg" aria-hidden="true" />
            <div style={{ position: 'relative' }}>
              <div className="v23-eyebrow">Our Process</div>
              <h2 className="v23-h2">Five steps from requisition to <span className="accent accent--teal">retained outcome</span>.</h2>
              <p className="v23-desc">
                Every Strategia engagement runs the same disciplined loop. The output of
                every step is auditable, exportable, and yours.
              </p>

              <div className="v23-process-steps">
                <div className="v23-process-line" aria-hidden="true" />
                {PROCESS_STEPS.map((step) => (
                  <div key={step.num} className="v23-process-step">
                    <div className="v23-process-step-num">{step.num}</div>
                    <div className="v23-process-step-title">{step.title}</div>
                    <div className="v23-process-step-module">{step.module}</div>
                    <p className="v23-process-step-desc">{step.desc}</p>
                  </div>
                ))}
              </div>

              <div className="v23-hero-actions" style={{ marginTop: 48 }}>
                <a href="/process" className="v23-btn-outline">Full process</a>
                <a href="/process" className="v23-link-arrow">
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-section" id="roi">
        <div className="v23-section-inner v23-reveal">
          <div className="v23-eyebrow">ROI calculator</div>
          <h2 className="v23-h2">See the savings for <span className="accent accent--sky">your&nbsp;system.</span></h2>
          <p className="v23-desc">
            Three inputs. Conservative assumptions. A number you can take to
            your&nbsp;CFO.
          </p>

          <div className="v23-roi-grid">
            <div className="v23-roi-inputs">
              <div>
                <div className="v23-roi-input-header">
                  <span className="k">Total Employees</span>
                  <span className="v">{ftes.toLocaleString()}</span>
                </div>
                <input
                  type="range"
                  className="v23-roi-slider"
            ...
            <div className="v23-roi-output">
              <div className="v23-roi-output-label">Projected annual savings</div>
              <div className="v23-roi-output-value">
                <span className="dollar">$</span>
                <span className="num">{bigValue}</span>
              </div>
              <p className="v23-roi-output-sub">
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v23-cta-section" id="demo">
        <div className="v23-cta-wrap v23-reveal">
          <div className="v23-cta-bg" aria-hidden="true" />
          <img
            src="/images/brand/glow/inline/strategia-final-logo-strategia-inline-white-glow.png"
            alt="Strategia"
            className="v23-cta-logo"
          />
          <h2 className="v23-h2">Cut avoidable attrition. <span className="accent accent--teal">Defend every hire.</span></h2>
          <p className="v23-desc">
            Most executives have great strategy and an opaque workforce. Strategia closes the gap.
          </p>
          <div className="v23-cta-actions">
            <a href="/demo" className="v23-btn-primary">Book a demo</a>
            <a href="/process" className="v23-link-arrow">
              Talk to us<span aria-hidden="true"> ↗</span>
            </a>
      ...
      <footer className="v23-footer">
        <div className="v23-footer-inner">
          <div className="v23-footer-top">
            <div className="v23-footer-brand">
              ...
              <div className="v23-footer-version">Strategia Intelligence Engine v2.1 &mdash; Live</div>
            </div>
          ...
          <div className="v23-footer-bottom">
            <div className="v23-footer-bottom-left">&copy; 2026 Strategia, Inc. All rights reserved.</div>
            <div className="v23-footer-bottom-right">
              <a href="/">Privacy</a>
              <a href="/">Terms</a>
