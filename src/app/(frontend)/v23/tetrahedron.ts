...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v23-hero') as HTMLElement | null
  const _stage = document.getElementById('v23Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v23Edges')
  const _glowEl = document.getElementById('v23Glow')
  const _stop0 = document.getElementById('v23GlowStop0')
  const _stop1 = document.getElementById('v23GlowStop1')
  const cursorAura = document.getElementById('v23CursorAura')
  const plasmaLayer = document.getElementById('v23PlasmaLayer')
  const _pulsesG = document.getElementById('v23Pulses')
  const pulseOverlay = document.getElementById('v23PulseOverlay')
  const spacer = document.querySelector('.v23-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v23:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v23-plasma-blob'
  ...
  function spawnPulse(scale: number = 1) {
    ...
    ring.setAttribute('fill', 'url(#v23PulseGrad)')
    ring.setAttribute('filter', 'url(#v23PulseBlur)')
