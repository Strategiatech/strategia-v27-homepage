...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v25-hero') as HTMLElement | null
  const _stage = document.getElementById('v25Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v25Edges')
  const _glowEl = document.getElementById('v25Glow')
  const _stop0 = document.getElementById('v25GlowStop0')
  const _stop1 = document.getElementById('v25GlowStop1')
  const cursorAura = document.getElementById('v25CursorAura')
  const plasmaLayer = document.getElementById('v25PlasmaLayer')
  const _pulsesG = document.getElementById('v25Pulses')
  const pulseOverlay = document.getElementById('v25PulseOverlay')
  const spacer = document.querySelector('.v25-scroll-spacer') as HTMLElement | null
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v25-plasma-blob'
  ...
  function spawnPulse(scale: number = 1) {
    ...
    ring.setAttribute('fill', 'url(#v25PulseGrad)')
    ring.setAttribute('filter', 'url(#v25PulseBlur)')
