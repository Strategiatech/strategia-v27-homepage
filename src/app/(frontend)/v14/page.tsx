...
export default function V14Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('v14:complete', handler)
    return () => window.removeEventListener('v14:complete', handler)
  }, [])
  ...
  useEffect(() => {
    const els = document.querySelectorAll<HTMLElement>('.v14-reveal')
  ...
  return (
    <div className={`v14${complete ? ' v14--complete' : ''}`}>
      {/* ================================================================
          NAVIGATION
          ================================================================ */}
      <nav className="v14-nav" ref={navRef}>
        <a href="/v14" className="v14-nav-logo">
          <img src="/images/logos/STRATEGIA_INLINE_NAVY.svg" alt="Strategia" />
        </a>
        <ul className="v14-nav-links">
          <li><a href="#platform" className="v14-nav-link">Platform</a></li>
          <li><a href="#modules" className="v14-nav-link">Modules</a></li>
          <li><a href="#science" className="v14-nav-link">Science</a></li>
          <li><a href="#solutions" className="v14-nav-link">Solutions</a></li>
          <li><a href="#enterprise" className="v14-nav-link">Enterprise</a></li>
          <li><a href="#process" className="v14-nav-link">Process</a></li>
        </ul>
        <a href="#demo" className="v14-nav-cta">Book demo</a>
      </nav>
      ...
      <section className="v14-hero">
        <div className="v14-cursor-aura" id="v14CursorAura" aria-hidden="true" />
        <div className="v14-plasma-layer" id="v14PlasmaLayer" aria-hidden="true" />
        ...
        <div className="v14-hero-copy">
          ...
          <div className="v14-hero-actions">
            <a href="#demo" className="v14-btn-outline">Book a demo</a>
            <a href="#platform" className="v14-link-arrow">
              Explore the platform<span aria-hidden="true"> ↗</span>
            </a>
          </div>
        </div>

        <div className="v14-tetra-stage" id="v14Stage">
          <svg id="v14Tetra" viewBox="-110 -110 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <radialGradient id="v14CoreGlow" cx="50%" cy="50%" r="50%">
                <stop id="v14GlowStop0" offset="0%" stopColor="var(--glow-color)" stopOpacity="0.55" />
                <stop id="v14GlowStop1" offset="40%" stopColor="var(--glow-color)" stopOpacity="0.18" />
                <stop offset="100%" stopColor="var(--glow-color)" stopOpacity="0" />
              </radialGradient>
              <radialGradient id="v14PulseGrad" cx="50%" cy="50%" r="50%">
              ...
              <filter id="v14GlowBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="6" />
              </filter>
              <filter id="v14PulseBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="10" />
              </filter>
            </defs>
            <g id="v14Pulses" />
            <circle id="v14Glow" cx="0" cy="0" r="60" fill="url(#v14CoreGlow)" filter="url(#v14GlowBlur)" />
            <g id="v14Edges" />
          </svg>

          <div className="v14-brand-lockup" id="v14BrandLockup" aria-hidden="true">
      ...
      <div className="v14-scroll-spacer" aria-hidden="true" />

      {/* ================================================================
          TRUSTED BY — Marquee
          ================================================================ */}
      <div className="v14-marquee-strip">
        <div className="v14-marquee-label">Trusted by leading<br />health systems</div>
        <div className="v14-marquee-track">
          <div className="v14-marquee-inner">
            {[...CLIENTS, ...CLIENTS].map((c, i) => (
              <div key={i} className="v14-marquee-item">
                <span className="v14-marquee-dot" aria-hidden="true" />
                {c}
              </div>
            ))}
          </div>
      ...
      {/* ================================================================
          STATS
          ================================================================ */}
      <section className="v14-stats v14-reveal">
        <div className="v14-stats-grid">
          <div className="v14-stat-card">
            <div className="v14-stat-card-header">
              <span>01</span><span>Outcome</span>
            </div>
            <div className="v14-stat-value">80%</div>
            <div className="v14-stat-label">Of internal recruitment automated</div>
            <div className="v14-stat-sub">Median across deployed health systems</div>
          </div>
          <div className="v14-stat-card">
            <div className="v14-stat-card-header">
              <span>02</span><span>Outcome</span>
            </div>
            <div className="v14-stat-value">&lt;25 min</div>
            <div className="v14-stat-label">1,000 CVs end-to-end</div>
            <div className="v14-stat-sub">From requisition to ranked shortlist</div>
          </div>
          <div className="v14-stat-card">
            <div className="v14-stat-card-header">
              <span>03</span><span>Outcome</span>
            </div>
            <div className="v14-stat-value">0.74</div>
            <div className="v14-stat-label">Match-score validity (mature)</div>
            <div className="v14-stat-sub">vs. 0.18 for resume review (Sackett 2022)</div>
          </div>
        </div>
      </section>
      ...
      {/* ================================================================
          PLATFORM — 8 Modules
          ================================================================ */}
      <section className="v14-section" id="modules">
        <div className="v14-section-inner v14-reveal">
          <div className="v14-section-header">
            <div>
              <div className="v14-eyebrow">The Platform &middot; 08 V-modules</div>
              <h2 className="v14-h2">
          ...
          <div className="v14-modules-grid">
            {MODULES.map((mod) => (
              <div key={mod.title} className="v14-module">
                <div className="v14-module-header">
                  <span className="v14-module-num">{mod.num}</span>
                  <span className="v14-module-tag">{mod.tag}</span>
                </div>
                <div className="v14-module-title">{mod.title}</div>
                <p className="v14-module-desc">{mod.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v14-triangulate">
        <div className="v14-triangulate-inner v14-reveal">
          <div className="v14-eyebrow">The Triangulate Method&trade;</div>
          <h2 className="v14-h2">
            Three signals. <span className="muted">One defensible composite score.</span>
          </h2>
          <p className="v14-desc">
          ...
          <div className="v14-eyebrow" style={{ marginTop: 40, marginBottom: 0, fontSize: 10 }}>
            Role &middot; ICU Nurse Specialist &middot; <span style={{ color: 'rgba(6,41,62,0.5)' }}>authored by V-Job</span>
          </div>

          <div className="v14-tri-signals">
            <div className="v14-tri-signal">
              <div className="v14-tri-signal-bar v14-tri-signal-bar--parse" />
              <div className="v14-tri-signal-label">CV signal</div>
              <div className="v14-tri-signal-name">V-Parse&trade;</div>
            </div>
            <div className="v14-tri-signal">
              <div className="v14-tri-signal-bar v14-tri-signal-bar--psych" />
              <div className="v14-tri-signal-label">Psych signal</div>
              <div className="v14-tri-signal-name">V-Psych&trade;</div>
            </div>
            <div className="v14-tri-signal">
              <div className="v14-tri-signal-bar v14-tri-signal-bar--interview" />
              <div className="v14-tri-signal-label">Interview signal</div>
              <div className="v14-tri-signal-name">V-Interview&trade;</div>
            </div>
          </div>

          <div className="v14-tri-converge">
            <div className="v14-tri-converge-dot" />
          </div>

          <div className="v14-tri-result">
            <div className="v14-tri-result-header">
              <span className="status">V-Fit &middot; Synthesis complete</span>
              <span>L. Ortega &middot; ICU Nurse Specialist</span>
            </div>
            <div className="v14-tri-result-body">
              <div className="v14-tri-score-block">
                <div className="v14-tri-score-label">JobFit&trade; Score</div>
                <div className="v14-tri-score-value">94</div>
                <div className="v14-tri-verdict">
              ...
              <div className="v14-tri-evidence">
                <div className="v14-tri-evidence-title">Key evidence</div>
                <ul className="v14-tri-evidence-list">
                  <li className="v14-tri-evidence-item">
                    <span className="v14-tri-evidence-tag">V-Parse</span>
                    <div>
                      <div className="v14-tri-evidence-text">Reg. Nurse (RN) License</div>
                      <div className="v14-tri-evidence-sub">Verified &middot; Lic. ID #PR01</div>
                    </div>
                  </li>
                  <li className="v14-tri-evidence-item">
                    <span className="v14-tri-evidence-tag">V-Psych</span>
                    <div>
                      <div className="v14-tri-evidence-text">Resilience + Empathy</div>
                      <div className="v14-tri-evidence-sub">T = 64 / 61 &middot; ICU role-fit cohort</div>
                    </div>
                  </li>
                  <li className="v14-tri-evidence-item">
                    <span className="v14-tri-evidence-tag">V-Interview</span>
                    <div>
                      <div className="v14-tri-evidence-text">Decision quality</div>
                      <div className="v14-tri-evidence-sub">0.91 weighted &middot; 4 scenario probes</div>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      {/* ================================================================
          SCIENCE
          ================================================================ */}
      <section className="v14-section" id="science">
        <div className="v14-section-inner v14-reveal">
          <div className="v14-section-header">
            <div>
              <div className="v14-eyebrow">The Science</div>
              <h2 className="v14-h2">
                Built on peer-reviewed psychometrics &mdash; <span className="muted">not retrofitted retail norms.</span>
              </h2>
              <p className="v14-desc" style={{ marginTop: 24 }}>
                Every score the platform produces is grounded in published validity research,
                calibrated on healthcare populations.
              </p>
            </div>
            <div className="v14-hero-actions">
              <a href="/science" className="v14-btn-outline">Read the research</a>
              <a href="/science" className="v14-link-arrow">
                Methodology<span aria-hidden="true"> ↗</span>
              </a>
            </div>
          </div>

          <div className="v14-science-grid">
            <div className="v14-science-stat">
              <div className="v14-science-stat-header">
      ...
      <section className="v14-section" id="solutions">
        <div className="v14-section-inner v14-reveal">
          <div className="v14-eyebrow">Solutions</div>
          <h2 className="v14-h2">
            Built for the people who own the workforce &mdash;{' '}
            <span className="muted">CHRO, recruiter, executive, clinical operator.</span>
          </h2>

          <div className="v14-solutions-grid">
            {SOLUTIONS.map((sol) => (
              <div key={sol.title} className="v14-solution-card">
                <div className="v14-solution-role">{sol.role}</div>
                <div className="v14-solution-title">{sol.title}</div>
                <p className="v14-solution-quote">{sol.quote}</p>
                <p className="v14-solution-body">{sol.body}</p>
                <div className="v14-solution-link">Explore <span aria-hidden="true">&rarr;</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ENTERPRISE
          ================================================================ */}
      <section className="v14-section" id="enterprise">
        <div className="v14-section-inner v14-reveal">
          <div className="v14-enterprise-wrap">
            <div className="v14-enterprise-bg" aria-hidden="true" />
            <div className="v14-enterprise-content">
              <div>
                <div className="v14-eyebrow">Enterprise</div>
                <h2 className="v14-h2">Deploy to the most regulated workforces in the country.</h2>
                <p className="v14-desc" style={{ marginTop: 24 }}>
                ...
                <div className="v14-hero-actions" style={{ marginTop: 32 }}>
                  <a href="/enterprise" className="v14-btn-outline">Enterprise &amp; security</a>
                  <a href="/process" className="v14-link-arrow">
                    Deployment process<span aria-hidden="true"> ↗</span>
                  </a>
                </div>
              </div>
              <div className="v14-badges-grid">
                {BADGES.map((b) => (
                  <div key={b} className="v14-badge-item">
                    <span className="v14-badge-check" aria-hidden="true">&#10003;</span>
                    {b}
                  </div>
                ))}
              </div>
      ...
      {/* ================================================================
          PROCESS
          ================================================================ */}
      <section className="v14-section" id="process">
        <div className="v14-section-inner v14-reveal">
          <div className="v14-process-wrap">
            <div className="v14-process-bg" aria-hidden="true" />
            <div style={{ position: 'relative' }}>
              <div className="v14-eyebrow">Our Process</div>
              <h2 className="v14-h2">Five steps from requisition to retained outcome.</h2>
              <p className="v14-desc">
                Every Strategia engagement runs the same disciplined loop. The output of
                every step is auditable, exportable, and yours.
              </p>

              <div className="v14-process-steps">
                <div className="v14-process-line" aria-hidden="true" />
                {PROCESS_STEPS.map((step) => (
                  <div key={step.num} className="v14-process-step">
                    <div className="v14-process-step-num">{step.num}</div>
                    <div className="v14-process-step-title">{step.title}</div>
                    <div className="v14-process-step-module">{step.module}</div>
                    <p className="v14-process-step-desc">{step.desc}</p>
                  </div>
                ))}
              </div>

              <div className="v14-hero-actions" style={{ marginTop: 48 }}>
                <a href="/process" className="v14-btn-outline">Full process</a>
                <a href="/process" className="v14-link-arrow">
      ...
      {/* ================================================================
          ROI CALCULATOR
          ================================================================ */}
      <section className="v14-section" id="roi">
        <div className="v14-section-inner v14-reveal">
          <div className="v14-eyebrow">ROI calculator</div>
          <h2 className="v14-h2">See the savings for your&nbsp;system.</h2>
          <p className="v14-desc">
            Three inputs. Conservative assumptions. A number you can take to
            your&nbsp;CFO.
          </p>

          <div className="v14-roi-grid">
            <div className="v14-roi-inputs">
              <div>
                <div className="v14-roi-input-header">
                  <span className="k">Total Employees</span>
                  <span className="v">{ftes.toLocaleString()}</span>
                </div>
                <input
                  type="range"
                  className="v14-roi-slider"
            ...
            <div className="v14-roi-output">
              <div className="v14-roi-output-label">Projected annual savings</div>
              <div className="v14-roi-output-value">
                <span className="dollar">$</span>{bigValue}
              </div>
              <p className="v14-roi-output-sub">
      ...
      {/* ================================================================
          FINAL CTA
          ================================================================ */}
      <section className="v14-cta-section" id="demo">
        <div className="v14-cta-wrap v14-reveal">
          <div className="v14-cta-bg" aria-hidden="true" />
          <h2 className="v14-h2">Turn hiring into a strategic lever.</h2>
          <p className="v14-desc">
      ...
      <footer className="v14-footer">
        <div className="v14-footer-inner">
          <div className="v14-footer-top">
            <div className="v14-footer-brand">
              ...
              <div className="v14-footer-version">Strategia Intelligence Engine v2.0 &mdash; Live</div>
            </div>
          ...
          <div className="v14-footer-bottom">
            <div className="v14-footer-bottom-left">&copy; 2026 Strategia, Inc. All rights reserved.</div>
            <div className="v14-footer-bottom-right">
              <a href="/">Privacy</a>
              <a href="/">Terms</a>
