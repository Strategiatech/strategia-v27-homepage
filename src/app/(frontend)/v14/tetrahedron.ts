...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v14-hero') as HTMLElement | null
  const _stage = document.getElementById('v14Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v14Edges')
  const _glowEl = document.getElementById('v14Glow')
  const _stop0 = document.getElementById('v14GlowStop0')
  const _stop1 = document.getElementById('v14GlowStop1')
  const cursorAura = document.getElementById('v14CursorAura')
  const plasmaLayer = document.getElementById('v14PlasmaLayer')
  const _pulsesG = document.getElementById('v14Pulses')
  const spacer = document.querySelector('.v14-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v14:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v14-plasma-blob'
  ...
  function spawnPulse() {
    ...
    ring.setAttribute('fill', 'url(#v14PulseGrad)')
    ring.setAttribute('filter', 'url(#v14PulseBlur)')
