...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v22-hero') as HTMLElement | null
  const _stage = document.getElementById('v22Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v22Edges')
  const _glowEl = document.getElementById('v22Glow')
  const _stop0 = document.getElementById('v22GlowStop0')
  const _stop1 = document.getElementById('v22GlowStop1')
  const cursorAura = document.getElementById('v22CursorAura')
  const plasmaLayer = document.getElementById('v22PlasmaLayer')
  const _pulsesG = document.getElementById('v22Pulses')
  const pulseOverlay = document.getElementById('v22PulseOverlay')
  const spacer = document.querySelector('.v22-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v22:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v22-plasma-blob'
  ...
  function spawnPulse() {
    ...
    ring.setAttribute('fill', 'url(#v22PulseGrad)')
    ring.setAttribute('filter', 'url(#v22PulseBlur)')
