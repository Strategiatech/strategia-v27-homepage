...
export default function V13Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('v13:complete', handler)
    return () => window.removeEventListener('v13:complete', handler)
  }, [])
  ...
  useEffect(() => {
    const els = document.querySelectorAll<HTMLElement>('.v13-reveal')
  ...
  return (
    <div className={`v13${complete ? ' v13--complete' : ''}`}>
      {/* ================================================================
          NAVIGATION
          ================================================================ */}
      <nav className="v13-nav" ref={navRef}>
        <a href="/v13" className="v13-nav-logo">
          <img src="/images/logos/STRATEGIA_INLINE_WHITE.svg" alt="Strategia" />
        </a>
        <ul className="v13-nav-links">
          <li><a href="#platform" className="v13-nav-link">Platform</a></li>
          <li><a href="#modules" className="v13-nav-link">Modules</a></li>
          <li><a href="#science" className="v13-nav-link">Science</a></li>
          <li><a href="#solutions" className="v13-nav-link">Solutions</a></li>
          <li><a href="#enterprise" className="v13-nav-link">Enterprise</a></li>
          <li><a href="#process" className="v13-nav-link">Process</a></li>
        </ul>
        <a href="#demo" className="v13-nav-cta">Book demo</a>
      </nav>
      ...
      <section className="v13-hero">
        <div className="v13-cursor-aura" id="v13CursorAura" aria-hidden="true" />
        <div className="v13-plasma-layer" id="v13PlasmaLayer" aria-hidden="true" />
        ...
        <div className="v13-hero-copy">
          ...
          <div className="v13-hero-actions">
            <a href="#demo" className="v13-btn-outline">Book a demo</a>
            <a href="#platform" className="v13-link-arrow">
              Explore the platform<span aria-hidden="true"> ↗</span>
            </a>
          </div>
        </div>

        <div className="v13-tetra-stage" id="v13Stage">
          <svg id="v13Tetra" viewBox="-110 -110 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <radialGradient id="v13CoreGlow" cx="50%" cy="50%" r="50%">
                <stop id="v13GlowStop0" offset="0%" stopColor="var(--glow-color)" stopOpacity="0.55" />
                <stop id="v13GlowStop1" offset="40%" stopColor="var(--glow-color)" stopOpacity="0.18" />
                <stop offset="100%" stopColor="var(--glow-color)" stopOpacity="0" />
              </radialGradient>
              <radialGradient id="v13PulseGrad" cx="50%" cy="50%" r="50%">
              ...
              <filter id="v13GlowBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="6" />
              </filter>
              <filter id="v13PulseBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="10" />
              </filter>
            </defs>
            <g id="v13Pulses" />
            <circle id="v13Glow" cx="0" cy="0" r="60" fill="url(#v13CoreGlow)" filter="url(#v13GlowBlur)" />
            <g id="v13Edges" />
          </svg>

          <div className="v13-brand-lockup" id="v13BrandLockup" aria-hidden="true">
      ...
      <div className="v13-scroll-spacer" aria-hidden="true" />

      {/* ================================================================
          TRUSTED BY — Marquee
          ================================================================ */}
      <div className="v13-marquee-strip">
        <div className="v13-marquee-label">Trusted by leading<br />health systems</div>
        <div className="v13-marquee-track">
          <div className="v13-marquee-inner">
            {[...CLIENTS, ...CLIENTS].map((c, i) => (
              <div key={i} className="v13-marquee-item">
                <span className="v13-marquee-dot" aria-hidden="true" />
                {c}
              </div>
            ))}
          </div>
      ...
      {/* ================================================================
          STATS
          ================================================================ */}
      <section className="v13-stats v13-reveal">
        <div className="v13-stats-grid">
          <div className="v13-stat-card">
            <div className="v13-stat-card-header">
              <span>01</span><span>Outcome</span>
            </div>
            <div className="v13-stat-value">80%</div>
            <div className="v13-stat-label">Of internal recruitment automated</div>
            <div className="v13-stat-sub">Median across deployed health systems</div>
          </div>
          <div className="v13-stat-card">
            <div className="v13-stat-card-header">
              <span>02</span><span>Outcome</span>
            </div>
            <div className="v13-stat-value">&lt;25 min</div>
            <div className="v13-stat-label">1,000 CVs end-to-end</div>
            <div className="v13-stat-sub">From requisition to ranked shortlist</div>
          </div>
          <div className="v13-stat-card">
            <div className="v13-stat-card-header">
              <span>03</span><span>Outcome</span>
            </div>
            <div className="v13-stat-value">0.74</div>
            <div className="v13-stat-label">Match-score validity (mature)</div>
            <div className="v13-stat-sub">vs. 0.18 for resume review (Sackett 2022)</div>
          </div>
        </div>
      </section>
      ...
      {/* ================================================================
          PLATFORM — 8 Modules
          ================================================================ */}
      <section className="v13-section" id="modules">
        <div className="v13-section-inner v13-reveal">
          <div className="v13-section-header">
            <div>
              <div className="v13-eyebrow">The Platform &middot; 08 V-modules</div>
              <h2 className="v13-h2">
          ...
          <div className="v13-modules-grid">
            {MODULES.map((mod) => (
              <div key={mod.title} className="v13-module">
                <div className="v13-module-header">
                  <span className="v13-module-num">{mod.num}</span>
                  <span className="v13-module-tag">{mod.tag}</span>
                </div>
                <div className="v13-module-title">{mod.title}</div>
                <p className="v13-module-desc">{mod.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v13-triangulate">
        <div className="v13-triangulate-inner v13-reveal">
          <div className="v13-eyebrow">The Triangulate Method&trade;</div>
          <h2 className="v13-h2">
            Three signals. <span className="muted">One defensible composite score.</span>
          </h2>
          <p className="v13-desc">
          ...
          <div className="v13-eyebrow" style={{ marginTop: 40, marginBottom: 0, fontSize: 10 }}>
            Role &middot; ICU Nurse Specialist &middot; <span style={{ color: 'rgba(238,240,246,0.7)' }}>authored by V-Job</span>
          </div>

          <div className="v13-tri-signals">
            <div className="v13-tri-signal">
              <div className="v13-tri-signal-bar v13-tri-signal-bar--parse" />
              <div className="v13-tri-signal-label">CV signal</div>
              <div className="v13-tri-signal-name">V-Parse&trade;</div>
            </div>
            <div className="v13-tri-signal">
              <div className="v13-tri-signal-bar v13-tri-signal-bar--psych" />
              <div className="v13-tri-signal-label">Psych signal</div>
              <div className="v13-tri-signal-name">V-Psych&trade;</div>
            </div>
            <div className="v13-tri-signal">
              <div className="v13-tri-signal-bar v13-tri-signal-bar--interview" />
              <div className="v13-tri-signal-label">Interview signal</div>
              <div className="v13-tri-signal-name">V-Interview&trade;</div>
            </div>
          </div>

          <div className="v13-tri-converge">
            <div className="v13-tri-converge-dot" />
          </div>

          <div className="v13-tri-result">
            <div className="v13-tri-result-header">
              <span className="status">V-Fit &middot; Synthesis complete</span>
              <span>L. Ortega &middot; ICU Nurse Specialist</span>
            </div>
            <div className="v13-tri-result-body">
              <div className="v13-tri-score-block">
                <div className="v13-tri-score-label">JobFit&trade; Score</div>
                <div className="v13-tri-score-value">94</div>
                <div className="v13-tri-verdict">
              ...
              <div className="v13-tri-evidence">
                <div className="v13-tri-evidence-title">Key evidence</div>
                <ul className="v13-tri-evidence-list">
                  <li className="v13-tri-evidence-item">
                    <span className="v13-tri-evidence-tag">V-Parse</span>
                    <div>
                      <div className="v13-tri-evidence-text">Reg. Nurse (RN) License</div>
                      <div className="v13-tri-evidence-sub">Verified &middot; Lic. ID #PR01</div>
                    </div>
                  </li>
                  <li className="v13-tri-evidence-item">
                    <span className="v13-tri-evidence-tag">V-Psych</span>
                    <div>
                      <div className="v13-tri-evidence-text">Resilience + Empathy</div>
                      <div className="v13-tri-evidence-sub">T = 64 / 61 &middot; ICU role-fit cohort</div>
                    </div>
                  </li>
                  <li className="v13-tri-evidence-item">
                    <span className="v13-tri-evidence-tag">V-Interview</span>
                    <div>
                      <div className="v13-tri-evidence-text">Decision quality</div>
                      <div className="v13-tri-evidence-sub">0.91 weighted &middot; 4 scenario probes</div>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      {/* ================================================================
          SCIENCE
          ================================================================ */}
      <section className="v13-section" id="science">
        <div className="v13-section-inner v13-reveal">
          <div className="v13-section-header">
            <div>
              <div className="v13-eyebrow">The Science</div>
              <h2 className="v13-h2">
                Built on peer-reviewed psychometrics &mdash; <span className="muted">not retrofitted retail norms.</span>
              </h2>
              <p className="v13-desc" style={{ marginTop: 24 }}>
                Every score the platform produces is grounded in published validity research,
                calibrated on healthcare populations.
              </p>
            </div>
            <div className="v13-hero-actions">
              <a href="/science" className="v13-btn-outline">Read the research</a>
              <a href="/science" className="v13-link-arrow">
                Methodology<span aria-hidden="true"> ↗</span>
              </a>
            </div>
          </div>

          <div className="v13-science-grid">
            <div className="v13-science-stat">
              <div className="v13-science-stat-header">
      ...
      <section className="v13-section" id="solutions">
        <div className="v13-section-inner v13-reveal">
          <div className="v13-eyebrow">Solutions</div>
          <h2 className="v13-h2">
            Built for the people who own the workforce &mdash;{' '}
            <span className="muted">CHRO, recruiter, executive, clinical operator.</span>
          </h2>

          <div className="v13-solutions-grid">
            {SOLUTIONS.map((sol) => (
              <div key={sol.title} className="v13-solution-card">
                <div className="v13-solution-role">{sol.role}</div>
                <div className="v13-solution-title">{sol.title}</div>
                <p className="v13-solution-quote">{sol.quote}</p>
                <p className="v13-solution-body">{sol.body}</p>
                <div className="v13-solution-link">Explore <span aria-hidden="true">&rarr;</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ENTERPRISE
          ================================================================ */}
      <section className="v13-section" id="enterprise">
        <div className="v13-section-inner v13-reveal">
          <div className="v13-enterprise-wrap">
            <div className="v13-enterprise-bg" aria-hidden="true" />
            <div className="v13-enterprise-content">
              <div>
                <div className="v13-eyebrow">Enterprise</div>
                <h2 className="v13-h2">Deploy to the most regulated workforces in the country.</h2>
                <p className="v13-desc" style={{ marginTop: 24 }}>
                ...
                <div className="v13-hero-actions" style={{ marginTop: 32 }}>
                  <a href="/enterprise" className="v13-btn-outline">Enterprise &amp; security</a>
                  <a href="/process" className="v13-link-arrow">
                    Deployment process<span aria-hidden="true"> ↗</span>
                  </a>
                </div>
              </div>
              <div className="v13-badges-grid">
                {BADGES.map((b) => (
                  <div key={b} className="v13-badge-item">
                    <span className="v13-badge-check" aria-hidden="true">&#10003;</span>
                    {b}
                  </div>
                ))}
              </div>
      ...
      {/* ================================================================
          PROCESS
          ================================================================ */}
      <section className="v13-section" id="process">
        <div className="v13-section-inner v13-reveal">
          <div className="v13-process-wrap">
            <div className="v13-process-bg" aria-hidden="true" />
            <div style={{ position: 'relative' }}>
              <div className="v13-eyebrow">Our Process</div>
              <h2 className="v13-h2">Five steps from requisition to retained outcome.</h2>
              <p className="v13-desc">
                Every Strategia engagement runs the same disciplined loop. The output of
                every step is auditable, exportable, and yours.
              </p>

              <div className="v13-process-steps">
                <div className="v13-process-line" aria-hidden="true" />
                {PROCESS_STEPS.map((step) => (
                  <div key={step.num} className="v13-process-step">
                    <div className="v13-process-step-num">{step.num}</div>
                    <div className="v13-process-step-title">{step.title}</div>
                    <div className="v13-process-step-module">{step.module}</div>
                    <p className="v13-process-step-desc">{step.desc}</p>
                  </div>
                ))}
              </div>

              <div className="v13-hero-actions" style={{ marginTop: 48 }}>
                <a href="/process" className="v13-btn-outline">Full process</a>
                <a href="/process" className="v13-link-arrow">
      ...
      {/* ================================================================
          ROI CALCULATOR
          ================================================================ */}
      <section className="v13-section" id="roi">
        <div className="v13-section-inner v13-reveal">
          <div className="v13-eyebrow">ROI calculator</div>
          <h2 className="v13-h2">See the savings for your&nbsp;system.</h2>
          <p className="v13-desc">
            Three inputs. Conservative assumptions. A number you can take to
            your&nbsp;CFO.
          </p>

          <div className="v13-roi-grid">
            <div className="v13-roi-inputs">
              <div>
                <div className="v13-roi-input-header">
                  <span className="k">Total Employees</span>
                  <span className="v">{ftes.toLocaleString()}</span>
                </div>
                <input
                  type="range"
                  className="v13-roi-slider"
            ...
            <div className="v13-roi-output">
              <div className="v13-roi-output-label">Projected annual savings</div>
              <div className="v13-roi-output-value">
                <span className="dollar">$</span>{bigValue}
              </div>
              <p className="v13-roi-output-sub">
      ...
      {/* ================================================================
          FINAL CTA
          ================================================================ */}
      <section className="v13-cta-section" id="demo">
        <div className="v13-cta-wrap v13-reveal">
          <div className="v13-cta-bg" aria-hidden="true" />
          <h2 className="v13-h2">Turn hiring into a strategic lever.</h2>
          <p className="v13-desc">
            Most executives have great strategy and an opaque workforce. Strategia closes the gap.
          </p>
          <div className="v13-cta-actions">
            <a href="/demo" className="v13-btn-outline">Book a demo</a>
            <a href="/process" className="v13-link-arrow">
              Talk to us<span aria-hidden="true"> ↗</span>
            </a>
      ...
      <footer className="v13-footer">
        <div className="v13-footer-inner">
          <div className="v13-footer-top">
            <div className="v13-footer-brand">
              ...
              <div className="v13-footer-version">Strategia Intelligence Engine v2.0 &mdash; Live</div>
            </div>
          ...
          <div className="v13-footer-bottom">
            <div className="v13-footer-bottom-left">&copy; 2026 Strategia, Inc. All rights reserved.</div>
            <div className="v13-footer-bottom-right">
              <a href="/">Privacy</a>
              <a href="/">Terms</a>
