...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v13-hero') as HTMLElement | null
  const _stage = document.getElementById('v13Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v13Edges')
  const _glowEl = document.getElementById('v13Glow')
  const _stop0 = document.getElementById('v13GlowStop0')
  const _stop1 = document.getElementById('v13GlowStop1')
  const cursorAura = document.getElementById('v13CursorAura')
  const plasmaLayer = document.getElementById('v13PlasmaLayer')
  const _pulsesG = document.getElementById('v13Pulses')
  const spacer = document.querySelector('.v13-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v13:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v13-plasma-blob'
  ...
  const wireFrontRGB = { r: 220, g: 226, b: 240 }
  const wireBackRGB = { r: 60, g: 68, b: 100 }
  ...
  function spawnPulse() {
    ...
    ring.setAttribute('fill', 'url(#v13PulseGrad)')
    ring.setAttribute('filter', 'url(#v13PulseBlur)')
