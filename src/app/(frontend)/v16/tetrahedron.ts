...
export function initTetrahedron(): () => void {
  ...
  const _hero = document.querySelector('.v16-hero') as HTMLElement | null
  const _stage = document.getElementById('v16Stage') as HTMLElement | null
  const _edgesG = document.getElementById('v16Edges')
  const _glowEl = document.getElementById('v16Glow')
  const _stop0 = document.getElementById('v16GlowStop0')
  const _stop1 = document.getElementById('v16GlowStop1')
  const cursorAura = document.getElementById('v16CursorAura')
  const plasmaLayer = document.getElementById('v16PlasmaLayer')
  const _pulsesG = document.getElementById('v16Pulses')
  const pulseOverlay = document.getElementById('v16PulseOverlay')
  const spacer = document.querySelector('.v16-scroll-spacer') as HTMLElement | null
  ...
  function completeInteraction() {
    ...
    targetGlow = 1
    window.scrollTo(0, 0)
    window.dispatchEvent(new CustomEvent('v16:complete'))
  }
  ...
  function spawnPlasmaBlob() {
    ...
    blob.className = 'v16-plasma-blob'
  ...
  function spawnPulse() {
    ...
    ring.setAttribute('fill', 'url(#v16PulseGrad)')
    ring.setAttribute('filter', 'url(#v16PulseBlur)')
