...
export default function V16Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('v16:complete', handler)
    return () => window.removeEventListener('v16:complete', handler)
  }, [])
  ...
  useEffect(() => {
    const els = document.querySelectorAll<HTMLElement>('.v16-reveal')
  ...
  return (
    <div className={`v16${complete ? ' v16--complete' : ''}`}>
      <div className="v16-pulse-overlay" id="v16PulseOverlay" aria-hidden="true" />

      {/* ================================================================
          NAVIGATION
          ================================================================ */}
      <nav className="v16-nav" ref={navRef}>
        <a href="/v16" className="v16-nav-logo">
          <img src="/images/logos/STRATEGIA_INLINE_NAVY.svg" alt="Strategia" />
        </a>
        <ul className="v16-nav-links">
          <li><a href="#platform" className="v16-nav-link">Platform</a></li>
          <li><a href="#modules" className="v16-nav-link">Modules</a></li>
          <li><a href="#science" className="v16-nav-link">Science</a></li>
          <li><a href="#solutions" className="v16-nav-link">Solutions</a></li>
          <li><a href="#enterprise" className="v16-nav-link">Enterprise</a></li>
          <li><a href="#process" className="v16-nav-link">Process</a></li>
        </ul>
        <a href="#demo" className="v16-nav-cta">Book demo</a>
      </nav>
      ...
      <section className="v16-hero">
        <div className="v16-cursor-aura" id="v16CursorAura" aria-hidden="true" />
        <div className="v16-plasma-layer" id="v16PlasmaLayer" aria-hidden="true" />
        ...
        <div className="v16-hero-copy">
          ...
          <div className="v16-hero-actions">
            <a href="#demo" className="v16-btn-outline">Book a demo</a>
            <a href="#platform" className="v16-link-arrow">
              Explore the platform<span aria-hidden="true"> ↗</span>
            </a>
          </div>
        </div>

        <div className="v16-tetra-stage" id="v16Stage">
          <svg id="v16Tetra" viewBox="-110 -110 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <defs>
              <radialGradient id="v16CoreGlow" cx="50%" cy="50%" r="50%">
                <stop id="v16GlowStop0" offset="0%" stopColor="var(--glow-color)" stopOpacity="0.55" />
                <stop id="v16GlowStop1" offset="40%" stopColor="var(--glow-color)" stopOpacity="0.18" />
                <stop offset="100%" stopColor="var(--glow-color)" stopOpacity="0" />
              </radialGradient>
              <radialGradient id="v16PulseGrad" cx="50%" cy="50%" r="50%">
              ...
              <filter id="v16GlowBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="6" />
              </filter>
              <filter id="v16PulseBlur" x="-50%" y="-50%" width="200%" height="200%">
                <feGaussianBlur stdDeviation="10" />
              </filter>
            </defs>
            <g id="v16Pulses" />
            <circle id="v16Glow" cx="0" cy="0" r="60" fill="url(#v16CoreGlow)" filter="url(#v16GlowBlur)" />
            <g id="v16Edges" />
          </svg>

          <div className="v16-brand-lockup" id="v16BrandLockup" aria-hidden="true">
      ...
      <div className="v16-scroll-spacer" aria-hidden="true" />

      {/* ================================================================
          TRUSTED BY — Marquee
          ================================================================ */}
      <div className="v16-marquee-strip">
        <div className="v16-marquee-label">Trusted by leading<br />health systems</div>
        <div className="v16-marquee-track">
          <div className="v16-marquee-inner">
            {[...CLIENTS, ...CLIENTS].map((c, i) => (
              <div key={i} className="v16-marquee-item">
                <span className="v16-marquee-dot" aria-hidden="true" />
                {c}
              </div>
            ))}
          </div>
      ...
      {/* ================================================================
          STATS
          ================================================================ */}
      <section className="v16-stats v16-reveal">
        <div className="v16-stats-grid">
          <div className="v16-stat-card">
            <div className="v16-stat-card-header">
              <span>01</span><span>Outcome</span>
            </div>
            <div className="v16-stat-value">80%</div>
            <div className="v16-stat-label">Of internal recruitment automated</div>
            <div className="v16-stat-sub">Median across deployed health systems</div>
          </div>
          <div className="v16-stat-card">
            <div className="v16-stat-card-header">
              <span>02</span><span>Outcome</span>
            </div>
            <div className="v16-stat-value">&lt;25 min</div>
            <div className="v16-stat-label">1,000 CVs end-to-end</div>
            <div className="v16-stat-sub">From requisition to ranked shortlist</div>
          </div>
          <div className="v16-stat-card">
            <div className="v16-stat-card-header">
              <span>03</span><span>Outcome</span>
            </div>
            <div className="v16-stat-value">0.74</div>
            <div className="v16-stat-label">Match-score validity (mature)</div>
            <div className="v16-stat-sub">vs. 0.18 for resume review (Sackett 2022)</div>
          </div>
        </div>
      </section>
      ...
      {/* ================================================================
          PLATFORM — 8 Modules
          ================================================================ */}
      <section className="v16-section" id="modules">
        <div className="v16-section-inner v16-reveal">
          <div className="v16-section-header">
            <div>
              <div className="v16-eyebrow">The Platform &middot; 08 V-modules</div>
              <h2 className="v16-h2">
          ...
          <div className="v16-modules-grid">
            {MODULES.map((mod) => (
              <div key={mod.title} className="v16-module">
                <div className="v16-module-header">
                  <span className="v16-module-num">{mod.num}</span>
                  <span className="v16-module-tag">{mod.tag}</span>
                </div>
                <div className="v16-module-title">{mod.title}</div>
                <p className="v16-module-desc">{mod.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="v16-triangulate">
        <div className="v16-triangulate-inner v16-reveal">
          <div className="v16-eyebrow">The Triangulate Method&trade;</div>
          <h2 className="v16-h2">
          ...
          <div className="v16-eyebrow" style={{ marginTop: 40, marginBottom: 0, fontSize: 10 }}>
            Role &middot; ICU Nurse Specialist &middot; <span style={{ color: 'rgba(6,41,62,0.5)' }}>authored by V-Job</span>
          </div>

          <div className="v16-tri-signals">
            <div className="v16-tri-signal">
              <div className="v16-tri-signal-bar v16-tri-signal-bar--parse" />
              <div className="v16-tri-signal-label">CV signal</div>
              <div className="v16-tri-signal-name">V-Parse&trade;</div>
            </div>
            <div className="v16-tri-signal">
              <div className="v16-tri-signal-bar v16-tri-signal-bar--psych" />
              <div className="v16-tri-signal-label">Psych signal</div>
              <div className="v16-tri-signal-name">V-Psych&trade;</div>
            </div>
            <div className="v16-tri-signal">
              <div className="v16-tri-signal-bar v16-tri-signal-bar--interview" />
              <div className="v16-tri-signal-label">Interview signal</div>
              <div className="v16-tri-signal-name">V-Interview&trade;</div>
            </div>
          </div>

          <div className="v16-tri-converge">
            <div className="v16-tri-converge-dot" />
          </div>

          <div className="v16-tri-result">
            <div className="v16-tri-result-header">
              <span className="status">V-Fit &middot; Synthesis complete</span>
              <span>L. Ortega &middot; ICU Nurse Specialist</span>
            </div>
            <div className="v16-tri-result-body">
              <div className="v16-tri-score-block">
                <div className="v16-tri-score-label">JobFit&trade; Score</div>
                <div className="v16-tri-score-value">94</div>
                <div className="v16-tri-verdict">
              ...
              <div className="v16-tri-evidence">
                <div className="v16-tri-evidence-title">Key evidence</div>
                <ul className="v16-tri-evidence-list">
                  <li className="v16-tri-evidence-item">
                    <span className="v16-tri-evidence-tag">V-Parse</span>
                    <div>
                      <div className="v16-tri-evidence-text">Reg. Nurse (RN) License</div>
                      <div className="v16-tri-evidence-sub">Verified &middot; Lic. ID #PR01</div>
                    </div>
                  </li>
                  <li className="v16-tri-evidence-item">
                    <span className="v16-tri-evidence-tag">V-Psych</span>
                    <div>
                      <div className="v16-tri-evidence-text">Resilience + Empathy</div>
                      <div className="v16-tri-evidence-sub">T = 64 / 61 &middot; ICU role-fit cohort</div>
                    </div>
                  </li>
                  <li className="v16-tri-evidence-item">
                    <span className="v16-tri-evidence-tag">V-Interview</span>
                    <div>
                      <div className="v16-tri-evidence-text">Decision quality</div>
                      <div className="v16-tri-evidence-sub">0.91 weighted &middot; 4 scenario probes</div>
                    </div>
                  </li>
                </ul>
              </div>
      ...
      {/* ================================================================
          SCIENCE
          ================================================================ */}
      <section className="v16-section" id="science">
        <div className="v16-section-inner v16-reveal">
          <div className="v16-section-header">
            <div>
              <div className="v16-eyebrow">The Science</div>
              <h2 className="v16-h2">
                Built on peer-reviewed psychometrics &mdash; <span className="muted">not retrofitted retail norms.</span>
              </h2>
              <p className="v16-desc" style={{ marginTop: 24 }}>
                Every score the platform produces is grounded in published validity research,
                calibrated on healthcare populations.
              </p>
            </div>
            <div className="v16-hero-actions">
              <a href="/science" className="v16-btn-outline">Read the research</a>
              <a href="/science" className="v16-link-arrow">
                Methodology<span aria-hidden="true"> ↗</span>
              </a>
            </div>
          </div>

          <div className="v16-science-grid">
            <div className="v16-science-stat">
              <div className="v16-science-stat-header">
      ...
      <section className="v16-section" id="solutions">
        <div className="v16-section-inner v16-reveal">
          <div className="v16-eyebrow">Solutions</div>
          <h2 className="v16-h2">
            Built for the people who own the workforce &mdash;{' '}
            <span className="muted">CHRO, recruiter, executive, clinical operator.</span>
          </h2>

          <div className="v16-solutions-grid">
            {SOLUTIONS.map((sol) => (
              <div key={sol.title} className="v16-solution-card">
                <div className="v16-solution-role">{sol.role}</div>
                <div className="v16-solution-title">{sol.title}</div>
                <p className="v16-solution-quote">{sol.quote}</p>
                <p className="v16-solution-body">{sol.body}</p>
                <div className="v16-solution-link">Explore <span aria-hidden="true">&rarr;</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ================================================================
          ENTERPRISE
          ================================================================ */}
      <section className="v16-section" id="enterprise">
        <div className="v16-section-inner v16-reveal">
          <div className="v16-enterprise-wrap">
            <div className="v16-enterprise-bg" aria-hidden="true" />
            <div className="v16-enterprise-content">
              <div>
                <div className="v16-eyebrow">Enterprise</div>
                <h2 className="v16-h2">Deploy to the most regulated workforces in the country.</h2>
                <p className="v16-desc" style={{ marginTop: 24 }}>
                ...
                <div className="v16-hero-actions" style={{ marginTop: 32 }}>
                  <a href="/enterprise" className="v16-btn-outline">Enterprise &amp; security</a>
                  <a href="/process" className="v16-link-arrow">
                    Deployment process<span aria-hidden="true"> ↗</span>
                  </a>
                </div>
              </div>
              <div className="v16-badges-grid">
                {BADGES.map((b) => (
                  <div key={b} className="v16-badge-item">
                    <span className="v16-badge-check" aria-hidden="true">&#10003;</span>
                    {b}
                  </div>
                ))}
              </div>
      ...
      {/* ================================================================
          PROCESS
          ================================================================ */}
      <section className="v16-section" id="process">
        <div className="v16-section-inner v16-reveal">
          <div className="v16-process-wrap">
            <div className="v16-process-bg" aria-hidden="true" />
            <div style={{ position: 'relative' }}>
              <div className="v16-eyebrow">Our Process</div>
              <h2 className="v16-h2">Five steps from requisition to retained outcome.</h2>
              <p className="v16-desc">
                Every Strategia engagement runs the same disciplined loop. The output of
                every step is auditable, exportable, and yours.
              </p>

              <div className="v16-process-steps">
                <div className="v16-process-line" aria-hidden="true" />
                {PROCESS_STEPS.map((step) => (
                  <div key={step.num} className="v16-process-step">
                    <div className="v16-process-step-num">{step.num}</div>
                    <div className="v16-process-step-title">{step.title}</div>
                    <div className="v16-process-step-module">{step.module}</div>
                    <p className="v16-process-step-desc">{step.desc}</p>
                  </div>
                ))}
              </div>

              <div className="v16-hero-actions" style={{ marginTop: 48 }}>
                <a href="/process" className="v16-btn-outline">Full process</a>
                <a href="/process" className="v16-link-arrow">
      ...
      {/* ================================================================
          ROI CALCULATOR
          ================================================================ */}
      <section className="v16-section" id="roi">
        <div className="v16-section-inner v16-reveal">
          <div className="v16-eyebrow">ROI calculator</div>
          <h2 className="v16-h2">See the savings for your&nbsp;system.</h2>
          <p className="v16-desc">
            Three inputs. Conservative assumptions. A number you can take to
            your&nbsp;CFO.
          </p>

          <div className="v16-roi-grid">
            <div className="v16-roi-inputs">
              <div>
                <div className="v16-roi-input-header">
                  <span className="k">Total Employees</span>
                  <span className="v">{ftes.toLocaleString()}</span>
                </div>
                <input
                  type="range"
                  className="v16-roi-slider"
            ...
            <div className="v16-roi-output">
              <div className="v16-roi-output-label">Projected annual savings</div>
              <div className="v16-roi-output-value">
                <span className="dollar">$</span>{bigValue}
              </div>
              <p className="v16-roi-output-sub">
      ...
      {/* ================================================================
          FINAL CTA
          ================================================================ */}
      <section className="v16-cta-section" id="demo">
        <div className="v16-cta-wrap v16-reveal">
          <div className="v16-cta-bg" aria-hidden="true" />
          <h2 className="v16-h2">Turn hiring into a strategic lever.</h2>
          <p className="v16-desc">
      ...
      <footer className="v16-footer">
        <div className="v16-footer-inner">
          <div className="v16-footer-top">
            <div className="v16-footer-brand">
              ...
              <div className="v16-footer-version">Strategia Intelligence Engine v2.0 &mdash; Live</div>
            </div>
          ...
          <div className="v16-footer-bottom">
            <div className="v16-footer-bottom-left">&copy; 2026 Strategia, Inc. All rights reserved.</div>
            <div className="v16-footer-bottom-right">
              <a href="/">Privacy</a>
              <a href="/">Terms</a>
