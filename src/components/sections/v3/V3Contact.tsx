export default function V3Contact() {
  return (
    <div className="v3-contact-band" id="contact">
      <div className="v3-contact-inner">
        <div className="v3-section-label">Engage</div>
        <div className="v3-contact-grid">
          <div className="v3-contact-copy">
            ...
            <p>
              Strategia is secure, tested, and integration-ready. We augment your
              internal capability — we don&apos;t replace it. Request a confidential
              executive briefing to discuss deployment for your organisation.
            </p>
            <ul className="v3-contact-checks">
              <li>
          ...
          <div className="v3-form-card">
            <div className="v3-form-title">Request Executive Briefing</div>
            ...
            <button className="v3-form-submit">
